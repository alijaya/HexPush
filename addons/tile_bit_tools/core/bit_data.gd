...
var IsometricCellNeighborsByMode := {
	TileSet.TerrainMode.TERRAIN_MODE_MATCH_CORNERS_AND_SIDES: [
...
var HorizontalHexCellNeighborsByMode := {
	TileSet.TerrainMode.TERRAIN_MODE_MATCH_CORNERS_AND_SIDES: [
		TileSet.CELL_NEIGHBOR_RIGHT_SIDE,
		TileSet.CELL_NEIGHBOR_BOTTOM_RIGHT_CORNER,
		TileSet.CELL_NEIGHBOR_BOTTOM_RIGHT_SIDE,
...
var VerticalHexCellNeighborsByMode := {
	TileSet.TerrainMode.TERRAIN_MODE_MATCH_CORNERS_AND_SIDES: [
		TileSet.CELL_NEIGHBOR_RIGHT_CORNER,
		TileSet.CELL_NEIGHBOR_BOTTOM_RIGHT_SIDE,
		TileSet.CELL_NEIGHBOR_BOTTOM_RIGHT_CORNER,
...
@export var tile_shape := TileSet.TileShape.TILE_SHAPE_SQUARE
@export var tile_offset_axis := TileSet.TileOffsetAxis.TILE_OFFSET_AXIS_HORIZONTAL # only important for hexagon
...
func get_cell_neighbors_by_mode() -> Dictionary:
	match tile_shape:
		TileSet.TileShape.TILE_SHAPE_SQUARE: return SquareCellNeighborsByMode
		TileSet.TileShape.TILE_SHAPE_ISOMETRIC: return IsometricCellNeighborsByMode
		TileSet.TileShape.TILE_SHAPE_HALF_OFFSET_SQUARE, TileSet.TileShape.TILE_SHAPE_HEXAGON:
			match tile_offset_axis:
				TileSet.TileOffsetAxis.TILE_OFFSET_AXIS_HORIZONTAL: return HorizontalHexCellNeighborsByMode
				TileSet.TileOffsetAxis.TILE_OFFSET_AXIS_VERTICAL: return VerticalHexCellNeighborsByMode
	return SquareCellNeighborsByMode
...
func get_terrain_bits_list(include_center_bit := false) -> Array:
	var list : Array = get_cell_neighbors_by_mode()[terrain_mode].duplicate()
...
func get_all_terrain_bits(include_center_bit := false) -> Array:
	var list : Array = get_cell_neighbors_by_mode()[TileSet.TerrainMode.TERRAIN_MODE_MATCH_CORNERS_AND_SIDES].duplicate()
	if include_center_bit:
		list.push_front(TerrainBits.CENTER)
	return list
...
func fill_all_tile_terrains(p_terrain_set : int, p_tile_shape : TileSet.TileShape, p_tile_offset_axis : TileSet.TileOffsetAxis, p_terrain_mode : TileSet.TerrainMode, terrain_index : int) -> void:
