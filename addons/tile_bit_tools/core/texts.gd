...
const TERRAIN_BIT_TEXTS := {
	...
	BitData.TerrainBits.RIGHT_CORNER: "Right Corner",
	BitData.TerrainBits.BOTTOM_RIGHT_SIDE: "Bottom Right Side",
	BitData.TerrainBits.BOTTOM_RIGHT_CORNER: "Bottom Right Corner",
	BitData.TerrainBits.BOTTOM_SIDE: "Bottom Side",
	BitData.TerrainBits.BOTTOM_CORNER: "Bottom Corner",
	BitData.TerrainBits.BOTTOM_LEFT_SIDE: "Bottom Left Side",
	BitData.TerrainBits.BOTTOM_LEFT_CORNER: "Bottom Left Corner",
	BitData.TerrainBits.LEFT_SIDE: "Left Side",
	BitData.TerrainBits.LEFT_CORNER: "Left Corner",
	BitData.TerrainBits.TOP_LEFT_SIDE: "Top Left Side",
	BitData.TerrainBits.TOP_LEFT_CORNER: "Top Left Corner",
	BitData.TerrainBits.TOP_SIDE: "Top Side",
	BitData.TerrainBits.TOP_CORNER: "Top Corner",
	BitData.TerrainBits.TOP_RIGHT_SIDE: "Top Right Side",
