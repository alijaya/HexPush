...
func fill_terrain(terrain_set : int, terrain_id : int) -> void:
	preview_bit_data = _get_new_preview_data()
	var tile_shape : int = tbt.context.tile_set.tile_shape
	var tile_offset_axis : int = tbt.context.tile_set.tile_offset_axis
	var terrain_mode : int = tbt.context.tile_set.get_terrain_set_mode(terrain_set)
	preview_bit_data.fill_all_tile_terrains(terrain_set, tile_shape, tile_offset_axis, terrain_mode, terrain_id)
